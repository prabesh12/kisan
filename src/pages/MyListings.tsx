  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Link
          to="/add-product"
          className="bg-primary-600 text-white px-6 py-3.5 sm:py-4 rounded-2xl font-bold hover:bg-primary-700 transition-all shadow-xl flex items-center justify-center space-x-2 active:scale-95 text-sm sm:text-base"
        >
          <PlusCircle size={20} />
            ...
            <div key={product.id} className="relative group flex flex-col">
              ...
              <div className="mt-4 flex space-x-2">
                <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 py-3 rounded-2xl font-bold transition-all active:scale-95 ${
                        product.status === 'sold' 
                ...
                <button
                   ...
                   className="p-3 bg-white border border-gray-200 rounded-2xl text-gray-400 hover:text-primary-600 hover:border-primary-100 transition-all active:scale-95"
                >
                   <Edit3 size={20} />
                </button>
              </div>
