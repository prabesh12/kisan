    ...
    <div className="max-w-2xl mx-auto py-8 px-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-gray-100">
        ...
        <div className="pt-20 pb-10 px-8 text-center space-y-8">
          ...
          {showSuccess && (
            <div className="bg-green-50 text-green-700 px-4 py-3 rounded-2xl flex items-center justify-center space-x-2 font-bold animate-bounce border border-green-100">
              <CheckCircle size={18} />
            ...
            <div className="space-y-2">
              ...
              {isEditing ? (
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-gray-50 border-2 border-gray-100 px-4 py-3 rounded-2xl font-bold text-gray-700 focus:border-primary-500 outline-none transition-all resize-none"
                />
              ) : (
          ...
          <div className="flex flex-col space-y-4 pt-4 max-w-md mx-auto">
            {isEditing ? (
              <button
                onClick={handleSave}
                 className="bg-primary-600 text-white font-bold py-4 rounded-2xl hover:bg-primary-700 shadow-xl transition-all flex items-center justify-center space-x-2"
              >
                <Save size={20} />
              ...
              <button
                onClick={() => setIsEditing(true)}
                 className="bg-white border-2 border-primary-600 text-primary-600 font-bold py-4 rounded-2xl hover:bg-primary-50 transition-all flex items-center justify-center space-x-2"
              >
                <UserIcon size={20} />
            ...
            <button
              onClick={handleLogout}
               className="bg-red-50 text-red-600 font-bold py-4 rounded-2xl hover:bg-red-100 transition-all flex items-center justify-center space-x-2 border-2 border-transparent hover:border-red-200"
            >
              <LogOut size={20} />
