    ...
    <div className="flex flex-col items-center justify-center space-y-16 py-12 px-4 text-center">
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 pt-8">
          <Link
            to="/home"
            className="bg-primary-600 text-white px-8 py-4 rounded-2xl text-lg font-bold hover:bg-primary-700 hover:scale-105 transition-all shadow-xl flex items-center justify-center space-x-2"
          >
          ...
          <Link
            to="/login"
            className="bg-white border-2 border-primary-100 text-primary-700 px-8 py-4 rounded-2xl text-lg font-bold hover:border-primary-300 hover:shadow-lg transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl pt-12">
        <div className="p-8 bg-white rounded-3xl shadow-sm border border-gray-100 text-left space-y-4">
          <div className="bg-primary-100 w-12 h-12 flex items-center justify-center rounded-2xl text-primary-700">
            <Leaf size={24} />
          </div>
        ...
        <div className="p-8 bg-white rounded-3xl shadow-sm border border-gray-100 text-left space-y-4">
          <div className="bg-earth-100 w-12 h-12 flex items-center justify-center rounded-2xl text-earth-700">
            <Users size={24} />
          </div>
        ...
        <div className="p-8 bg-white rounded-3xl shadow-sm border border-gray-100 text-left space-y-4">
          <div className="bg-green-100 w-12 h-12 flex items-center justify-center rounded-2xl text-green-700">
            <Sprout size={24} />
          </div>
