  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <header className="md:hidden flex bg-white shadow-sm sticky top-0 z-50 px-4 py-3 justify-between items-center border-b border-gray-100">
        <Link to="/" className="text-xl font-black font-heading text-primary-700 tracking-tight">
          Kisan <span className="text-earth-600">App</span>
        </Link>
        <button
          onClick={() => i18n.changeLanguage(i18n.language === 'en' ? 'ne' : 'en')}
      ...
      {/* Main Content Area */}
      <main className="flex-1 pb-24 md:pb-8 pt-6 px-4 max-w-6xl mx-auto w-full">
        {children}
      </main>
